      ...
      <Dialog open={linkModalOpen} onOpenChange={setLinkModalOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Compartilhe este link com seu cliente para visualização e aprovação da proposta.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
              ...
              <Button variant="outline" className="w-full" onClick={() => window.open(generatedLink, '_blank')}>
