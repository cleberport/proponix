    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <Button variant="ghost" size="sm" onClick={() => navigate('/auth')}
              className="text-neutral-600 hover:bg-neutral-900 hover:text-white text-xs sm:text-sm font-medium rounded-full">
              Entrar
            </Button>
      ...
      <section className="relative pt-32 pb-16 md:pt-44 md:pb-24">
        <div className="relative mx-auto max-w-4xl px-5 text-center">
          ...
          <motion.h1
            className="text-[2rem] sm:text-[2.75rem] md:text-[3.5rem] font-bold leading-[1.1] tracking-[-0.03em] text-neutral-900"
