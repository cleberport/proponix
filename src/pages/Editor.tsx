...
const Editor = () => {
  ...
  const addElement = useCallback((type: ElementType) => {
    ...
    const newEl: CanvasElement = {
      ...
      width: type === 'divider' ? 515 : type === 'service' ? 300 : type === 'shape' ? 200 : type === 'total-calculation' ? 250 : 200,
      height: type === 'divider' ? 2 : type === 'notes' ? 80 : type === 'service' ? 140 : type === 'shape' ? 100 : type === 'total-calculation' ? 40 : 30,
      content: type === 'text' ? 'Novo Texto' : type === 'notes' ? 'Observações...' : type === 'dynamic-field' ? '' : type === 'price-field' ? '' : type === 'total-calculation' ? '' : '',
